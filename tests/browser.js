...
document.getElementById('run').onclick=async()=>{
 ...
 try{
  ...
  let r=await detector.analyze(c.getContext('2d').getImageData(0,0,c.width,c.height),{sensitivity:1});
  ...
  results.push('7 checks passed. Temporary test record removed.');
